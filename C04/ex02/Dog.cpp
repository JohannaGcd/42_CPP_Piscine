...
Dog::Dog(const std::string &type) : AAnimal("Dog"), brain(new Brain()) {
  (void)type;

  std::cout << "Parameterized constructor: Dog object was created."
            << std::endl;
}
...
Dog &Dog::operator=(const Dog &other) {
  std::cout << "Copy assignment operator: Dog object was assigned."
            << std::endl;
