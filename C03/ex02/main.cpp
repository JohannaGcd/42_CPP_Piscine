...
static void testConstructionDestructionChaining() {
  ...
  std::cout << "Expected constructor order: ClapTrap, then FragTrap"
            << std::endl;
...
// testConstructors
// testFragTrapMethods
// prompt for "good practice"
// send to AI what i wrote, ask if its ok (would answer on how to make
// improvements to industry) edge cases
